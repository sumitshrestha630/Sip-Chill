export const SHOP_DATA = {
  ...
  daiquiris: [
    { id: "strawberry",    name: "Strawberry",        desc: "Fresh strawberries, rum, lime",                 color: "#E8485A", size: "16 oz / 32 oz", price: 8  },
    { id: "mango",         name: "Mango",             desc: "Sweet mango, coconut rum, pineapple",           color: "#F0A830", size: "16 oz / 32 oz", price: 8  },
    { id: "pina-colada",   name: "Piña Colada",       desc: "Coconut cream, pineapple, white rum",           color: "#F5E4A0", size: "16 oz / 32 oz", price: 8  },
    { id: "hurricane",     name: "Hurricane",         desc: "Passion fruit, dark & light rum, citrus",       color: "#D94F20", size: "16 oz / 32 oz", price: 9  },
    { id: "watermelon",    name: "Watermelon",        desc: "Fresh watermelon, mint, vodka",                 color: "#F06080", size: "16 oz / 32 oz", price: 8  },
    { id: "blue-raz",      name: "Blue Raspberry",    desc: "Tart blue raspberry, triple sec, rum",          color: "#5080E8", size: "16 oz / 32 oz", price: 8  },
    { id: "peach",         name: "Peach",             desc: "Georgia peach, peach schnapps, rum",            color: "#F0A070", size: "16 oz / 32 oz", price: 8  },
    { id: "lemonade",      name: "Spiked Lemonade",   desc: "Fresh lemon, simple syrup, citrus vodka",       color: "#F5E060", size: "16 oz / 32 oz", price: 8  },
    { id: "pineapple",     name: "Pineapple",         desc: "Tropical pineapple, coconut, white rum",        color: "#D4C840", size: "16 oz / 32 oz", price: 8  },
    { id: "sex-beach",     name: "Sex on the Beach",  desc: "Peach schnapps, cranberry, OJ, vodka",          color: "#E87040", size: "16 oz / 32 oz", price: 9  },
    { id: "grape",         name: "Grape",             desc: "Concord grape, lime, rum",                      color: "#9060D0", size: "16 oz / 32 oz", price: 8  },
    { id: "classic",       name: "Classic Daiquiri",  desc: "White rum, fresh lime, cane sugar",             color: "#C8F0A8", size: "16 oz / 32 oz", price: 8, pick: true },
  ],
  products: [
