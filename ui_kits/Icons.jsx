// Icon set — Lucide-style SVG icons. Stroke 1.5, currentColor.
const Icon = ({ name, size = 20, ...p }) => {
  const props = { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round", ...p };
  switch (name) {
